  ...
  <div v-else>
    <div class="camera-view" v-if="currentStep < 4">
      <navi-top
        ...
        @update:weld_class="weld_class = $event"
      ...
      <weld-choice
        class="left-bottom"
        @updateWeldClass="weld_class = $event"
        v-if="currentStep === 1"
      >
      </weld-choice>
      <operation-sidebar
      ...
      <view class="left-bottom" v-if="currentStep === 3">
        ...
        <weld-set
          :data="identityData"
          @listChange="handleChangeData"
        ></weld-set>
      </view>
    </div>
    <div v-if="currentStep === 4">
      <welding-message
        :weld_param="weld_param"
        :weld_list="weldList"
      ></welding-message>
    </div>
  </div>
...
export default {
  ...
  methods: {
    ...
    combineWeldData(data) {
      const { weld_datas = [], weld_images = [] } = data;
      const imageMap = {};
