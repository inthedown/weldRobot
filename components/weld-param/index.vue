<template>
  <view>
    <tip-card
      title="工艺包参数设置"
      :class="{ 'highlight-border': isParamSet }"
    >
      ...
      <view v-else class="add-param" @click="handleOpenDialog">
        <uni-icons
          ...
          color="#00c3ff"
        ></uni-icons
        ><text class="add-text add-content">新增工艺包配置</text>
...
.highlight-border {
  ...
  border-radius: 8rpx;
  animation: flashYellow 0.5s ease-in-out 2s alternate;
}
